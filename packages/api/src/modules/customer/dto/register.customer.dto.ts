...
import { RegisterCustomerInput } from '@pikslots/shared';
import {
  IsString,
  IsUUID,
  IsOptional,
...
export class RegisterCustomerDto implements RegisterCustomerInput {
  ...
  @ApiProperty({
    example: { Instagram: 'https://instagram.com/johndoe' },
    description: 'Social media links keyed by platform',
  })
  @IsObject()
