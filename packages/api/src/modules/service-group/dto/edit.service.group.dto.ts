...
import type { EditServiceGroupInput } from '@pikslots/shared';

export class EditServiceGroupDto implements EditServiceGroupInput {
  @ApiProperty({
  ...
  @ApiProperty({
    ...
    description: 'Full desired list of service IDs for this group',
  })
  @IsArray()
